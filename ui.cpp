...
void Ui::filterUi() {
	...
	if (optiune == 1) {
		...
		cin >> ore;
		clearInputBuffer();
		vector <Disciplina> filtrat = controller.filterOre(ore);
		...
		cout << "Nume profesor: ";
		cin >> profesor;
		vector <Disciplina> filtrat = controller.filterProfesor(profesor);
		cout << GREEN << "Disciplinele filtrate sunt:\n" << RESET;
		printDiscipline(filtrat);
	}
	else {
...
void Ui::sortUi() {
	...
	if (optiune == 1) {
		vector <Disciplina> sortat = controller.sortDenumire();
		cout << GREEN << "Disciplinele sortate sunt:\n" << RESET;
		printDiscipline(sortat);
	}
	else if (optiune == 2) {
		vector <Disciplina> sortat = controller.sortOre();
		cout << GREEN << "Disciplinele sortate sunt:\n" << RESET;
		printDiscipline(sortat);
	}
	else if (optiune == 3) {
		vector <Disciplina> sortat = controller.sortProfTip();
		cout << GREEN << "Disciplinele sortate sunt:\n" << RESET;
		printDiscipline(sortat);
	}
	else {
